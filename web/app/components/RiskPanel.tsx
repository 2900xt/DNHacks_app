 ...
 *
 * Two things are on screen that a risk number usually hides.
 *
 ...
 *
 * The CEILING. 46% is the highest rate ever actually observed at any score. A
 * node sitting there reads "at least" — the model cannot separate it from the
 * others up there, and says so instead of inventing a decimal.
 */
export default function RiskPanel({ risk }: { risk: NodeRisk | null }) {
  ...
  const { p12, band, basis, why, from, upstream, atCeiling } = risk
